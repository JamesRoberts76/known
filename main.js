document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendMessage() {
        ...
        loadingMsg.innerHTML = '<strong>James:</strong> Auditing established variables and baseline competence...';
        feed.appendChild(loadingMsg);
        portal.scrollTop = portal.scrollHeight;

        const currentDomain = window.location.hostname;
        const siteId = currentDomain.includes('guide') ? currentDomain : 'known.guide';
